...
<div class="container super-dark-grey">
  <div class="questions-background">
    <div class="row-flex pad48">
      ...
      <a class="content-button" href="contact.php" style="margin-left: 32px">ASK US</a>
    </div>
  </div>
</div>

<!-- Footer container -->
<div class="container dark-dark-grey">
  <div class="row footer-row">
    <div class="footer-column">
      <span class="footer-title clearboth">Contact</span>
      <span class="footer-subtitle clearboth bottom32">Located in the Latin American & Caribbean Studies Institute, University of Georgia</span>
      <div class="extra"></div>
      <div class="footer-flex bottom16">
        <img class="footer-icon" src="assets/phone.svg" alt="">
        <span><a href="tel:+1-706-542-0470">(706) 542-0470</a></span>
      </div>
      <div class="footer-flex bottom16">
        <img class="footer-icon" src="assets/email.svg" alt="">
        <span><a href="mailto:schmaltz@uga.edu">schmaltz@uga.edu</a></span>
      </div>
      <div class="footer-flex bottom16">
        <img class="footer-icon" src="assets/office.svg" alt="">
  ...
  <div class="row" style="max-width: none">
    <div class="column darker-grey">
      <div class="footer-flex pad16 nomargin">
        <img style="max-height: 50px" src="http://www.portflagship.org/wp-content/uploads/2018/11/uga-small.png" alt="">
        <span class="footer-disclaimer left-text">
          The content and opinions expressed on this web page do not necessarily reflect the views of nor are they endorsed
